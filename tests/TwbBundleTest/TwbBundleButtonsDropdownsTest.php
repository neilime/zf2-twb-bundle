...
class TwbBundleButtonsDropdownsTest extends \PHPUnit_Framework_TestCase{
	...
	public function testSingleButtonDropdowns(){
		...
		//file_put_contents($this->expectedPath.'dropdowns-single.phtml',str_replace(PHP_EOL,"\n",$sContent));
	...
	public function testSplitButtonDropdowns(){
		...
		//file_put_contents($this->expectedPath.'dropdowns-split.phtml',str_replace(PHP_EOL,"\n",$sContent));
	...
	public function testDropdownsSizing(){
		...
		//Test content
		//file_put_contents($this->expectedPath.'dropdowns-sizing.phtml',str_replace(PHP_EOL,"\n",$sContent));
	...
	public function testDropup(){
		...
		//Test content
		//file_put_contents($this->expectedPath.'dropup.phtml',str_replace(PHP_EOL,"\n",$sContent));
