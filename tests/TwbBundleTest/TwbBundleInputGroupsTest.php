...
class TwbBundleInputGroupsTest extends \PHPUnit_Framework_TestCase{
	...
	public function testBasicExample(){
		...
		file_put_contents($this->expectedPath.'input-groups-basic.phtml',str_replace(PHP_EOL,"\n",$sContent));
	...
	public function testSizing(){
		...
		file_put_contents($this->expectedPath.'input-groups-sizing.phtml',str_replace(PHP_EOL,"\n",$sContent));
	...
	public function testCheckboxesAndRadioAddons(){
		...
		file_put_contents($this->expectedPath.'input-groups-checkboxes-radios.phtml',str_replace(PHP_EOL,"\n",$sContent));
	...
	public function testButtonAddons(){
		...
		file_put_contents($this->expectedPath.'input-groups-buttons.phtml',str_replace(PHP_EOL,"\n",$sContent));
	...
	public function testButtonsWithDropdowns(){
		...
		file_put_contents($this->expectedPath.'input-groups-buttons-dropdowns.phtml',str_replace(PHP_EOL,"\n",$sContent));
	...
	public function testSegmentedButtons(){
		...
		file_put_contents($this->expectedPath.'input-groups-buttons-segmented.phtml',str_replace(PHP_EOL,"\n",$sContent));
