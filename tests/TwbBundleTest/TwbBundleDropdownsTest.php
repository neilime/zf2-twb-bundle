...
class TwbBundleDropdownsTest extends \PHPUnit_Framework_TestCase{
	...
	public function testExample(){
		...
		//file_put_contents($this->expectedPath.'exemple.phtml',str_replace(PHP_EOL,"\n",$this->dropdownHelper->__invoke($aDropDownOptions)));
	...
	public function testAlignment(){
		...
		//file_put_contents($this->expectedPath.'alignment.phtml',str_replace(PHP_EOL,"\n",$this->dropdownHelper->__invoke($aDropDownOptions)));
	...
	public function testHeaders(){
		...
		//file_put_contents($this->expectedPath.'headers.phtml',str_replace(PHP_EOL,"\n",$this->dropdownHelper->__invoke($aDropDownOptions)));
	...
	public function testDisabled(){
		...
		//file_put_contents($this->expectedPath.'disabled.phtml',str_replace(PHP_EOL,"\n",$this->dropdownHelper->__invoke($aDropDownOptions)));
