...
class TwbBundleAlertsTest extends \PHPUnit_Framework_TestCase{
	...
	public function testExamples(){
		...
		file_put_contents($this->expectedPath.'alerts-examples.phtml',str_replace(PHP_EOL,"\n",$sContent));
	...
	public function testDismissableAlerts(){
		...
		file_put_contents($this->expectedPath.'alerts-dismissable.phtml',str_replace(PHP_EOL,"\n",$sContent));
