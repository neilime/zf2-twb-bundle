...
class TwbBundleFormsTest extends \PHPUnit_Framework_TestCase{
	...
	public function testBasicExample(){
		...
		//file_put_contents($this->expectedPath.'basic-example.phtml',str_replace(PHP_EOL,"\n",$this->formHelper->__invoke($oForm,null)));
	...
	public function testHorizontalform(){
		...
		//file_put_contents($this->expectedPath.'horizontal-form.phtml',str_replace(PHP_EOL,"\n",$this->formHelper->__invoke($oForm)));
	...
	public function testSupportedControlsform(){
		...
		//file_put_contents($this->expectedPath.'supported-controls-form.phtml',str_replace(PHP_EOL,"\n",$this->formHelper->__invoke($oForm,null)));
	...
	public function testStaticControlform(){
		...
		//file_put_contents($this->expectedPath.'static-control-form.phtml',str_replace(PHP_EOL,"\n",$this->formHelper->__invoke($oForm)));
	...
	public function testControlStatesform(){
		...
		//file_put_contents($this->expectedPath.'control-states-form.phtml',str_replace(PHP_EOL,"\n",$this->formHelper->__invoke($oForm,null)));
	...
	public function testFormsValidation(){
		...
		//file_put_contents($this->expectedPath.'forms-validation.phtml',str_replace(PHP_EOL,"\n",$this->formHelper->__invoke($oForm,null)));
	...
	public function testFormsControlSizes(){
		...
		//file_put_contents($this->expectedPath.'forms-control-sizes-height.phtml',str_replace(PHP_EOL,"\n",$this->formHelper->__invoke($oForm,null)));
		...
		//file_put_contents($this->expectedPath.'forms-control-sizes-column.phtml',str_replace(PHP_EOL,"\n",$this->formHelper->__invoke($oForm,\TwbBundle\Form\View\Helper\TwbBundleForm::LAYOUT_INLINE)));
	...
	public function testFormsHelpText(){
		...
		//file_put_contents($this->expectedPath.'forms-help-text.phtml',str_replace(PHP_EOL,"\n",$this->formHelper->__invoke($oForm,null)));
